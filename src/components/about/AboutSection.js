        ...
        <div className='about-section container'>
            <div className='about-section-content'>
                <div className='about-section-left'>
                    <h1>About 33rd Street Detox</h1>
                    <p>At 33rd Street Detox, we understand that the path to recovery begins with compassionate care and a supportive environment. Our dedicated team is committed to helping individuals break free from the grips of substance abuse and start on their journey towards a healthier, more fulfilling life.</p>
