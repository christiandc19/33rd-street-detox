        ...
        <div className='detox-section '>
            ...
            <div className='detox-section-header'>
                ...
                <div className='detox-section-flex'>
                    ...
                    < div className='detox-section-right'>
                ...
                <div className='detox-section-flex2'>

                    <div className='detox-section-left2'>
                        <img src={TreatmentImage2} alt="Rehab Team" loading="lazy" />
                    </div>

                    < div className='detox-section-right2'>
